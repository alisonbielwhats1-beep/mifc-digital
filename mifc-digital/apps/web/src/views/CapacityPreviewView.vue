...
<template>
  <div class="page">
    ...
    <div class="context-banner"><span><strong>CT com dois modos.</strong> Manual usa o valor cadastrado. Automático reproduz a conta do Power BI com tempo líquido ÷ produção observada; quando a fonte ou a unidade ainda não está homologada, o Layout mostra “Aguardando fonte” em vez de inventar um número.</span><DataOriginBadge origin="IMPORT" /></div>
        ...
        <div class="table-scroll">
          <table class="data-table capacity-table">
            ...
            <tbody>
              ...
              <tr v-if="visibleRows.length === 0"><td colspan="15"><div class="empty-row">Nenhum processo corresponde à busca.</div></td></tr>
            </tbody>
          </table>
        </div>
      </article>

      <FormSourcePanel><strong class="source-title"><Gauge :size="15" />Classificação aplicada</strong><p>Tempo de Ciclo, capacidade nominal, turnos, disponibilidade, unidade, OEE-meta e WIP-meta são parâmetros. No modo automático, a produção e as paradas vêm do MES em leitura; o contador técnico atual é RAIL_ID e não deve ser tratado como peça física sem homologação. Capacidade/dia, utilização e gargalo permanecem pendentes onde a regra específica ainda não foi comprovada.</p></FormSourcePanel>
    </section>
  </div>
</template>
