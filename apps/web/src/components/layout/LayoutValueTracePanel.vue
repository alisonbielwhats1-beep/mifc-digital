...
import type { BufferFormRow } from "@/stores/mifc-forms";

const props = defineProps<{ trace: LayoutValueTrace; editableBuffer?: BufferFormRow }>();
const emit = defineEmits<{ close: []; updateBuffer: [id: string, patch: Partial<BufferFormRow>] }>();
