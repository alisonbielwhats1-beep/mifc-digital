...
const emit = defineEmits<{ select: [id: string, event: MouseEvent | KeyboardEvent]; dragstart: [event: PointerEvent, node: LayoutNode]; resizestart: [event: PointerEvent, node: LayoutNode] }>();
</script>
