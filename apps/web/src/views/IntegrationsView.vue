...
@media(max-width:900px){.workspace-grid,.security-grid{grid-template-columns:1fr}.integration-card{grid-template-columns:100px 1fr}.safety-seal{grid-column:1/-1;justify-self:start}.shipping-metrics{grid-template-columns:1fr 1fr}.shipping-metrics>div:nth-child(2){border-right:0}}@media(max-width:560px){.integration-card,.environment-list{grid-template-columns:1fr}.environment-list>div{border-right:0}.catalog-header,.shipping-header{align-items:flex-start;flex-direction:column}.shipping-metrics{grid-template-columns:1fr}.shipping-metrics>div{border-right:0}.shipping-actions .button{width:100%}.test-button{width:100%}.page-heading{align-items:flex-start;flex-direction:column}}
</style>
